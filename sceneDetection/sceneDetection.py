...
import re
from sceneDetection.helperFiles.utils import Utils
import sceneDetection.helperFiles.params as yamnet_params
import sceneDetection.helperFiles.yam as yamnet_model
...
class SceneDetection:
    ...
    def load_model(self):
        ...
        yamnet.load_weights(os.getcwd() + '/sceneDetection/helperFiles/model.h5')
        yamnet_classes = yamnet_model.class_names(os.getcwd() + '/sceneDetection/helperFiles/yam_class_map.csv')
